        ...
        <div class="mt-5 flex lg:mt-0 lg:ml-4">
            ...
            <span class="relative lg:hidden" x-data="{ isOpen: false }">
                ...
                <div
                    ...
                    class="origin-top-right absolute right-0 mt-2 -mr-1 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5" aria-labelledby="mobile-menu" role="menu">
