...
<a href="{{ $href ?? '#' }}" class="group flex items-center px-2 py-2 text-lg lg:text-sm leading-6 font-medium rounded-md text-chocolate-100 hover:text-white hover:bg-chocolate-600">
